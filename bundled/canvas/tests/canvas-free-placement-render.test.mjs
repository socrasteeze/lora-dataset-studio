...
import { clampImageBox, imageNodeExtent } from '../frontend/utils/canvasImageNodes.js'
import { layoutImageNodes } from '../frontend/utils/canvasImageGroups.js'
import { fitView, stackLanes } from '../frontend/utils/canvasLayout.js'
import { laneStackEntries } from '../frontend/utils/canvasPinBatch.js'
import { render } from '../../../frontend/tests/support/mountJsx.mjs'
...
const { default: CanvasImageNode } =
  await import('../frontend/components/canvas/CanvasImageNode.jsx')
const { default: CanvasImageGroup } =
  await import('../frontend/components/canvas/CanvasImageGroup.jsx')
...
test('the stack is measured on the RESTING rows, never on the gesture', () => {
  ...
  const canvas = readFileSync(
    new URL('../frontend/components/canvas/LineageCanvas.jsx', import.meta.url), 'utf8')
