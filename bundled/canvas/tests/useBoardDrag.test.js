...
import { renderToStaticMarkup, createElement } from '../../../frontend/tests/support/mountJsx.mjs';
// Resolve the hook after mountJsx has installed the same shared-React resolver
// as the other bundled render tests; a static import resolves too early.
const { useBoardDrag } = await import('../frontend/components/canvas/boardNodes/useBoardDrag.js');
