...
import { isNodeControlTarget, nodePointerIntent } from '../frontend/utils/canvasNodeChrome.js'

const src = readFileSync(
  new URL('../frontend/components/canvas/ExternalLoraNodes.jsx', import.meta.url), 'utf8')
...
const insidePopover = {
  closest: (sel) => sel.split(',').some((one) => {
    ...
    if (s.startsWith('../../../frontend/tests')) return portalRoot.includes(s.slice(1))
    return false
  }) ? {} : null,
}
