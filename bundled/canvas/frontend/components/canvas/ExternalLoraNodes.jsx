...
import { KleinLoraCombobox, useKleinGenerationLoras } from '@lds/plugin-sdk/canvas';
import { findLora } from '@lds/plugin-sdk/canvas';
import { clampStrength, MAX_EXTERNAL_LORAS } from '@lds/plugin-sdk/canvas';
import { normalizeLoraName } from './boardNodes/registry.js';
...
/* 🔌 The 'external-lora' board-node type's markup: the board card
   (`ExternalLoraCard`) and the add popover (`ExternalLoraAddFlow`). Both are
   registered onto `BOARD_NODE_TYPES['external-lora']` via lazy loaders in
   `boardNodes/registry.js` — `BoardNodeLayer.jsx` mounts them, drag and
   board-space positioning are its job (`boardNodes/useBoardDrag.js`), not
