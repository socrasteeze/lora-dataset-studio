...
import { installActionLabel } from '@lds/plugin-sdk'
import { CAMERA_ACTION_LABELS, cameraInstallPlan } from '../lib/cameraInstall.js'
                ...
                <li key={a} className="flex items-center justify-between gap-2 text-sm">
                  <span className="flex min-w-0 items-center gap-2">
                    ...
                    <span className="truncate text-content-muted">
                      {CAMERA_ACTION_LABELS[a] || installActionLabel(a)}
                    </span>
                  </span>
