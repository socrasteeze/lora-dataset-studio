...
def _local_llm_ready(provider) -> tuple[bool, str, str]:
    ...
    if provider == 'lmstudio':
        from lds_sdk.video_host import vision_lmstudio
    ...
    from lds_sdk.video_host import vision_ollama
...
def resolve_backend(fresh=False) -> dict:
    ...
    def _transformers():
        from lds_video.video_caption_worker import unavailable_reason
...
def _write_caption_frames(src_path, times, dest_dir, stem):
    ...
    from lds_video.video_clip_search import _write_frames
