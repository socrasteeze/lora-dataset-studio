...
test('the gallery lightbox, given what the panel passes, shows ✨ beside ⬇', () => {
  ...
  assert.deepEqual(improveButtons(html), ['klein', 'seedvr2'],
    'Both active restoration products remain discoverable before preparation')
...
test("the modal ✨ opens carries Klein's note — pointers and the instruction editor", async () => {
  ...
  const stream = await renderToReadableStream(createElement(ToastProvider, null,
    createElement(CapabilitiesProvider, null, createElement(ImproveModal, {
