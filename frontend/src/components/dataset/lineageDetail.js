...
const CONFIG_LABELS = [
  ...
  [['content_or_style'], 'Krea content / style'],
  [['do_differential_guidance'], 'Differential guidance'],
  [['differential_guidance_scale'], 'Differential guidance scale'],
