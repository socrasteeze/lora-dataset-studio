...
export default function UnavailablePluginPage({ label = 'This workspace' }) {
  return <section className="space-y-4 rounded-xl border border-border bg-surface p-5">
    ...
    <p role="status" className="text-sm text-content-muted">Its plugin is not active in this session. Open My plugins to check whether it is installed, enabled, or needs a reload.</p>
