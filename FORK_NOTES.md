...
## Divergence 5: patches carried on upstream TEST files — CURRENTLY EMPTY
...
**There are none right now** (as of 2026-07-28). The section stays because the
situation recurs, and because the one entry it held is the worked example of how
these are meant to end:
...
14. **The Divergence-3 strip script must change ONLY the glyphs — a "tidy the
